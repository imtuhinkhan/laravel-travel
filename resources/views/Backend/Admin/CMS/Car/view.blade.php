        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Car Content Management</h4>

                </div>
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab1" data-bs-toggle="tab">Cars</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="solid-justified-tab2">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/carCms/1') }}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @method('PUT')
