        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Accessiories Content Management</h4>

                </div>
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab1" data-bs-toggle="tab">
                            Accessiories
                        </a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="solid-justified-tab2">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/accessioriesCms/1') }}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @method('PUT')
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-2">Hotel Title</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="title" value="{{$acc->title}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea rows="5" cols="5" class="form-control" placeholder="Enter text here" name="description">{{$acc->description}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="title_ru" value="{{$acc->title_ru}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea rows="5" cols="5" class="form-control" placeholder="Enter text here" name="description_ru">{{$acc->description_ru}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="title_am" value="{{$acc->title_am}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea rows="5" cols="5" class="form-control" placeholder="Enter text here" name="description_am">{{$acc->description_am}}</textarea>
                                            </div>
                                        </div>
