...
<div class="page-header">
    <div class="row">
        <div class="col-sm-12">
            <h2 class="page-title" style="text-align: center">Update Form</h2>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
            ...
            <div class="card-body">
                <form id="tourForm" action="/admin/nearby/update/{{ $things->id }}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @method('PUT')
